      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-6 flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 mt-1">Gestiona las empresas con las que trabajas</p>
          </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200">
          <div className="p-16 text-center">
            ...
            <h3 className="text-lg font-medium text-gray-900 mb-2">No hay empresas aún</h3>
            <p className="text-gray-600 mb-6">Agrega las empresas con las que trabajas para organizar mejor tus contactos y tratos.</p>
